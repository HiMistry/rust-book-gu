...
મોટાભાગના Rust વિકાસકર્તાઓ સ્થિર ચેનલનો
...
```
```
મોટાભાગના Rust userઓ સક્રિયપણે બીટા આવૃત્તિઓનો ઉપયોગ કરતા નથી, પરંતુ Rustને સંભવિત ઘટાડા શોધવામાં મદદ કરવા માટે તેમના CI સિસ્ટમમાં બીટા સામે પરીક્ષણ કરે છે. તે દરમિયાન, દરરોજ રાત્રે નવી nightly આવૃત્તિ ઉપલબ્ધ છે:
...
```
```
જેમ કે તમે જોઈ શકો છો, સ્થિર સાધનસંચાલન (toolchain) મૂળભૂત છે. મોટાભાગના Rust userઓ મોટા ભાગે સ્થિરનો ઉપયોગ કરે છે. તમે મોટા ભાગે સ્થિરનો ઉપયોગ કરવા માગી શકો છો, પરંતુ કોઈ ચોક્કસ પ્રોજેક્ટમાં nightly નો ઉપયોગ કરવો કેમ કે તમને અત્યાધુનિક સુવિધાની કાળજી છે. આવું કરવા માટે, તમે તે પ્રોજેક્ટની ડિરેક્ટરીમાં `rustup override` નો ઉપયોગ કરી શકો છો જેથી nightly સાધનસંચાલનને `rustup` એ જે ડિરેક્ટરીમાં હોવ ત્યારે વાપરવું જોઈએ.
