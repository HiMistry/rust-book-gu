...
- `derive` દ્વારા પૂરી પાડવામાં આવેલ લક્ષણની અમલીકરણ શું કરે છે.

- લક્ષણનો અમલ પ્રકાર વિશે શું સૂચવે છે. The

- તમે લક્ષણનો અમલ ક્યારે કરી શકો છો અને ક્યારે ન કરી શકો તેવા સંજોગો.

- કાર્યોના ઉદાહરણો જે લક્ષણની આવશ્યકતા ધરાવે છે.
...
Trait `Eq` લક્ષણમાં કોઈ પદ્ધતિઓ નથી. તેનો હેતુ એ દર્શાવવાનો છે કે, નોંધાયેલ પ્રકારની દરેક કિંમત પોતાની સાથે સમાન હોય છે. `Eq` લક્ષણ માત્ર તે જ પ્રકારો પર લાગુ કરી શકાય છે જે `PartialEq` લક્ષણને પણ અમલમાં મૂકે છે, જોકે બધા પ્રકારો જે `PartialEq` લક્ષણને અમલમાં મૂકે છે તેઓ `Eq` લક્ષણને અમલમાં મૂકી શકતા નથી. આનું એક ઉદાહરણ ફ્લોટિંગ-પોઇન્ટ સંખ્યા પ્રકારો છે: ફ્લોટિંગ-પોઇન્ટ નંબરોનો અમલ જણાવે છે કે નોટ-એ-નંબર ( `NaN` ) કિંમતના બે ઉદાહરણો એકબીજા સાથે સમાન નથી.
...
`PartialOrd` લક્ષણ તમને પ્રકારના ઉદાહરણોને સૉર્ટિંગ હેતુઓ માટે સરખાવવા દે છે. `PartialOrd` લાગુ કરાયેલ પ્રકારનો ઉપયોગ `<` , `>` , `<=` , અને `>=` ઓપરેટરો સાથે થઈ શકે છે. તમે માત્ર એવા પ્રકારો પર `PartialOrd` લક્ષણ લાગુ કરી શકો છો જે `PartialEq` પણ લાગુ કરે છે.
...
`Ord` ટ્રેઇટ તમને જણાવે છે કે નોંધાયેલ પ્રકારના કોઈપણ બે મૂલ્યો માટે, માન્ય ક્રમ અસ્તિત્વમાં રહેશે. `Ord` ટ્રેઇટ `cmp` પદ્ધતિનો અમલ કરે છે, જે `Option<Ordering>` ને બદલે `Ordering` પરત કરે છે કારણ કે માન્ય ક્રમ હંમેશા શક્ય હશે. તમે માત્ર એવા પ્રકારો પર `Ord` ટ્રેઇટ લાગુ કરી શકો છો જે `PartialOrd` અને `Eq` (અને `Eq` ને `PartialEq` ની જરૂર છે) બંનેનો અમલ પણ કરે છે. જ્યારે સ્ટ્રક્ચર્સ અને એનુમ્સ પર મેળવવામાં આવે છે, ત્યારે `cmp` વર્તે છે જેમ કે `partial_cmp` નો મેળવેલો અમલ `PartialOrd` સાથે કરે છે.
