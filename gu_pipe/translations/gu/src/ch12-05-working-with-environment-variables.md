...
સૌ પ્રથમ, અમે `query` સ્ટ્રિંગને નાના અક્ષરોમાં ફેરવીએ છીએ અને તેને એક નવા ચલ (variable) માં સંગ્રહિત કરીએ છીએ, જેનું નામ પહેલાંના `query` ને છાયા પાડે છે. ક્વેરી પર `to_lowercase` બોલાવવું જરૂરી છે જેથી વપરાશકર્તાની ક્વેરી `"rust"` , `"RUST"` , `"Rust"` અથવા `"rUsT"` હોય તો પણ, અમે ક્વેરીને જાણે તે `"rust"` હોય તેમ ગણીશું અને કેસ પ્રત્યે સંવેદનશીલ નહીં રહીએ. જ્યારે `to_lowercase` મૂળભૂત યુનિકોડ (Unicode) ને હેન્ડલ કરશે, ત્યારે તે 100 ટકા સચોટ રહેશે નહીં. જો અમે વાસ્તવિક એપ્લિકેશન લખતા હોત, તો અહીં થોડું વધારે કામ કરવું જોઈતું હતું, પરંતુ આ વિભાગ પર્યાવરણ ચલો (environment variables) વિશે છે, યુનિકોડ વિશે નહીં, તેથી અમે તેને ત્યાં જ છોડી દઈએ છીએ.
...
અંતે, આપણે પર્યાવરણ ચલ (environment variable) માટે તપાસ કરવી જરૂરી છે. પર્યાવરણ ચલો સાથે કાર્ય કરવાના વિધેયો પ્રમાણિત પુસ્તકાલય (standard library) માં `env` મોડ્યુલમાં છે, જે src/main.rs ના પ્રારંભિક ભાગમાં પહેલાથી જ ઉપલબ્ધ છે. આપણે `var` વિધેયનો ઉપયોગ `env` મોડ્યુલમાંથી કરીશું, જેથી ચકાસી શકાય કે `IGNORE_CASE` નામનાં પર્યાવરણ ચલ માટે કોઈ મૂલ્ય સેટ થયું છે કે નહીં, જે યાદી 12-23 માં દર્શાવેલ છે.
...
અહીં, આપણે એક નવું ચલ, `ignore_case`, બનાવીએ છીએ. તેની કિંમત સેટ કરવા માટે, આપણે `env::var` વિધેયને બોલાવીએ છીએ અને તેને `IGNORE_CASE` પર્યાવરણ ચલનું નામ પસાર કરીએ છીએ. `env::var` વિધેય એક `Result` આપે છે જે સફળ `Ok` પ્રકાર હશે જેમાં પર્યાવરણ ચલની કિંમત હોય જો પર્યાવરણ ચલ કોઈ પણ મૂલ્ય પર સેટ કરેલો હોય. જો પર્યાવરણ ચલ સેટ ન હોય તો તે `Err` પ્રકાર આપશે.
...
જો તમે PowerShell વાપરી રહ્યા છો, તો તમારે પર્યાવરણ ચલ સેટ કરવું પડશે અને કાર્યક્રમને અલગ આદેશો તરીકે ચલાવવો પડશે:
