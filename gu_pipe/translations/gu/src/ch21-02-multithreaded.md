...
pub fn spawn<F, T>(f: F) -> JoinHandle<T>
    where
        ...
        T: Send + 'static,
```
[`spawn`][builder-spawn] `JoinHandle<T>` ચાલો `JoinHandle` નો ઉપયોગ કરવાનો પ્રયત્ન કરીએ અને જોઈએ કે શું થાય છે. આપણી પરિસ્થિતિમાં, આપણે થ્રેડ પૂલને પાસ કરેલા ક્લોઝર્સ કનેક્શનનું સંચાલન કરશે અને કંઈપણ પરત કરશે નહીં, તેથી `T` એ યુનિટ પ્રકાર `()` હશે. The code in Listing 21-14
