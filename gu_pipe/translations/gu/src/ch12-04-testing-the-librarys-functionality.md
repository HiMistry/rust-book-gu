...
This test searches for the string `"duct"` . આ પરીક્ષણ `"duct"` શબ્દ શોધે છે. જે લખાણોમાં આપણે શોધી રહ્યા છીએ તે ત્રણ લીટીઓનાં છે, જેમાંની માત્ર એક લીટીમાં `"duct"` આવેલું છે (નોંધ કરો કે ઉઘાડતી બેવડી અવતરણ ચિહ્નની પછી બેકસ્લેશ Rust ને આ શબ્દપ્રયોગની શરૂઆતમાં નવી લાઇન મૂકવાનું કહેતું નથી). આપણે ખાતરી કરીએ છીએ કે `search` કાર્ય દ્વારા મળેલું પરિણામ માત્ર એ જ લીટી
...
હવે ચાલો ચર્ચા કરીએ કે શા માટે આપણે સ્પષ્ટ આયુષ્ય `'a` ને `search` ના નિશ્ચિત રૂપરેખામાં વ્યાખ્યાયિત કરવાની અને તે આયુષ્યનો ઉપયોગ `contents` દલીલ અને વળતર મૂલ્ય સાથે કરવાની જરૂર છે. યાદ કરો પ્રકરણ ૧૦ માં કે આયુષ્ય પરિમાણો કઈ દલીલ આયુષ્યને વળતર આયુષ્ય સાથે જોડે છે. આ કિસ્સામાં, અમે દર્શાવે છે કે પરત કરેલ વેક્ટર સ્ટ્રિંગ સ્લાઇસ ધરાવવું જોઈએ જે `contents` દલીલના સ્લાઇસનો સંદર્ભ આપે છે (બળિયા `query` દલીલને બદલે).
