...
સૌ પ્રથમ, નોંધ કરો કે ચલ ઘોષણા (variable declaration) અને વિધેય વળતર મૂલ્ય (function return value) માંની તમામ ટ્યૂપલ કોડ ગાયબ થઈ ગયો છે. બીજું, ધ્યાન આપો કે અમે `&s1` ને `calculate_length` માં પસાર કરીએ છીએ અને તેની વ્યાખ્યામાં અમે `&String` લેવાємо, `String` ને બદલે. આ એમ્પરસેન્ડ સંદર્ભો (references) દર્શાવે છે, અને તે તમને માલિકી લીધા વિના કોઈ મૂલ્યનો ઉલ્લેખ કરવાની મંજૂરી આપે છે. આકૃતિ 4-6 આ ખ્યાલને દર્શાવે છે.
...
જે રીતે ચલ અચળ હોય છે, તેવી જ રીતે સંદર્ભો પણ અચળ હોય છે. આપણને જે સંદર્ભ મળ્યો છે, તેને આપણે બદલી શકતા નથી.
