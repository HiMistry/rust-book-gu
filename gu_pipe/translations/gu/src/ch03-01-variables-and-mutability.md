...
તમને `cannot assign twice to immutable variable \`x\``  એવો ભૂલ સંદેશ મળ્યો કારણ કે તમે અપરિવર્તનશીલ `x` ચલને બીજી કિંમત સોંપવાનો પ્રયાસ કર્યો હતો.
...
હવે કે આપણે ચલ કેવી રીતે કાર્ય કરે છે તે તપાસ્યું છે, ચાલો આપણે જોઈએ કે તેઓ કયા વધુ પ્રકારના ડેટા ધરાવી શકે છે.
