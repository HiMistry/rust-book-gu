...
Notice that we don’t include the `unsafe` keyword in this code. દેખો કે આ કોડમાં અમે `unsafe` કીવર્ડનો સમાવેશ કરતા નથી. અમે સુરક્ષિત કોડમાં કા રો પોઇન્ટર્સ બનાવી શકીએ છીએ; પરંતુ, થોડા સમય પછી તમે જોશો તેમ, કા રો પોઇન્ટર્સને અનસુરક્ષિત બ્લોક બહાર ડિરેફરન્સ
...
Marking a function as `safe` does not inherently make it safe! વિધેયને `safe` તરીકે નિરૂપણ કરવાથી તે આપોઆપ સુરક્ષિત નથી! તેના બદલે, તમે Rust ને આપી રહ્યા છો કે તે સુરક્ષિત છે એવો સંકલ્પ. તમારી જવાબદારી હજી પણ એ સંકલ્પ જાળવવાની રહે છે!
...
Static ચલ સ્થિર ચલ અચલ (constants) જેવા જ હોય છે, જે આપણે પ્રકરણ ૩ માં “અચલ જાહેર કરવા” વિભાગમાં ચર્ચા કરી હતી. સ્થિર ચલના નામો `SCREAMING_SNAKE_CASE` સંમેત મુજબ હોય છે. સ્થિર ચલ માત્ર `'static` આયુષ્યકાળ (lifetime) ધરાવતા સંદર્ભો (references) સંગ્રહિત કરી શકે છે, જેનો અર્થ થાય છે કે Rust કમ્પાઇલર આયુષ્યકાળ નક્કી કરી શકે છે અને આપણને સ્પષ્ટપણે નોંધ કરવાની આવશ્યકતા નથી. અમુટ (immutable) સ્થિર ચલને ઍક્સેસ કરવું સુરક્ષિત છે.
