...
ભાષાઓમાં જે તેમના પ્રમાણિત પુસ્તકાલયો દ્વારા ઇટરેટર (iterator) પ્રદાન કરતા નથી, તમે સંભવતઃ આ જ કાર્યક્ષમતા લખશો એ માટે એક ચલને અનુક્રમણિકા 0 થી શરૂ કરીને, તે ચલનો ઉપયોગ વેક્ટર (vector) માં અનુક્રમિત કરવા માટે મૂલ્ય મેળવવા અને ચલના મૂલ્યમાં વધારો કરવો જ્યાં સુધી તે વેક્ટર (vector) માં વસ્તુઓની કુલ સંખ્યા સુધી ન પહોંચે ત્યાં સુધી લૂપ (loop) માં. ઇટરેટર (iterator) તમારા માટે આ તમામ તર્કનું
...
The `shoes_in_size` Function `shoes_in_size` કાર્ય વેક્ટર (vector) ની જૂતાની અને એક જૂતાના કદને પરિમાણો તરીકે સ્વીકારે છે. તે માત્ર નિર્ધારિત કદના જૂતાઓ ધરાવતું વેક્ટર પરત કરે છે. `shoes_in_size`
