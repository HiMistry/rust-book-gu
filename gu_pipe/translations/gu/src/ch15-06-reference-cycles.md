...
આપણે ચલ `a` માં `5, Nil` ની પ્રારંભિક યાદી ધરાવતું `Rc<List>` ઉદાહરણ બનાવીએ છીએ. ત્યારબાદ આપણે ચલ `b` માં બીજું `Rc<List>` ઉદાહરણ બનાવીએ છીએ જે `10` નું મૂલ્ય ધરાવે છે અને `a` માં રહેલી યાદી તરફ નિર્દેશ કરે છે.
