...
At the time, we said not to worry about the inefficient `clone` calls because we would remove them in the future. Well, that time is now! તે સમયે, અમે કહ્યું હતું કે બિનકાર્યક્ષમ
